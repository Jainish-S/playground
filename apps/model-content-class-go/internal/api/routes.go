...
import (
	...
	"github.com/playground/apps/model-content-class-go/internal/config"
	"github.com/playground/apps/model-content-class-go/internal/inference"
	gocommon "github.com/playground/packages/go-common"
)

const modelName = "content-class"
...
func (h *Handler) handlePredict(w http.ResponseWriter, r *http.Request) {
	...
	flagged, score, details := inference.ClassifyContent(req.Text)
